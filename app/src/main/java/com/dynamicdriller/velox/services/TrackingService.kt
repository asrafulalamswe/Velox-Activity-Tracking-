package com.dynamicdriller.velox.services
...
import com.dynamicdriller.velox.other.Constants.FASTEST_LOCATION_INTERVAL
import com.dynamicdriller.velox.other.Constants.LOCATION_UPDATE_INTERVAL
import com.dynamicdriller.velox.other.Constants.NOTIFICATION_CHANNEL_ID
import com.dynamicdriller.velox.other.Constants.NOTIFICATION_CHANNEL_NAME
import com.dynamicdriller.velox.other.Constants.NOTIFICATION_ID
import com.dynamicdriller.velox.other.Constants.TIMER_UPDATE_INTERVAL
...
class TrackingService: LifecycleService() {
    ...
    private fun startForegroundService() {
        ...
        timeRunInSeconds.observe(this, Observer {
            if(!serviceKilled){
                val noitification = currentNotificationBuilder
                    .setContentText(TrackingUtility.getFormattedStopWatchTime(it * 1000L))
                    .setSmallIcon(R.drawable.ic_bicycle)
                notificationManager.notify(NOTIFICATION_ID, noitification.build())
            }
        })
    }
